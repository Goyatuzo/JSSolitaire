...
function Card( r, s )
{
	...
	switch(s) {
		case "heart":
			...
			break;
		case "spade":
			this.obj = $('<div class="sample-card-design" id="'+r+s+'"> <div class="cardbackground"> <div class="' + s + '"style="top:2%;left:5%">T</div> <div class="cardIdentifier">' + r + '</div> <div class="' + s + '" style="bottom:3.3333%;right:4%">T</div> </div> </div>' );
			break;
		case "club":
